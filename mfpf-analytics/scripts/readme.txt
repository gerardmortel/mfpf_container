...
Step 1: initenv.sh - The script logs into the Container service. The script is a prerequisite to run any of the following scripts
...
startanalyticsgroup.sh - Run the script startanalyticsgroup.sh to run the analytics image as a Container group.